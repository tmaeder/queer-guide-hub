...
**Only 22 cities have committed geometry, against 2,142 in the directory, so the
fallback is the common case and the difference has to be VISIBLE.** A real network
