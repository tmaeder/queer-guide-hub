            ...
            <DialogContent style={{ maxWidth: 672 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <Typography sx={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>
                  Import products from Awin CSV data feeds. Leave CSV URL blank to use the default
                  feed with your API credentials.
                </Typography>
                ...
                <Box>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setImportParams((prev) => ({ ...prev, csvUrl: e.target.value }))
                    }
                  />
                  <Typography
                    sx={{ fontSize: '0.75rem', color: 'var(--muted-foreground)', mt: 0.5 }}
                  >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setFormData((prev) => ({ ...prev, shipping_available: checked as boolean }))
                      }
                    />
            ...
            {filteredListings.map((listing) => (
              <Box
                ...
                sx={{
                  ...
                  borderColor: 'divider',
                  borderRadius: 2,
                  '&:hover': { bgcolor: 'var(--muted)', opacity: 0.5 },
                }}
              >
                <Box sx={{ flex: 1 }}>
                  ...
                  >
                    ...
                    {listing.location && <Box>Location: {listing.location}</Box>}
                  </Box>
