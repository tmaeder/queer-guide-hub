            ...
            >
              ...
              {selectedCity && (
                <>
                  ...
                  <Typography component="span" sx={{ px: 1, py: 0.5, fontWeight: 500 }}>
                    {selectedCity.name}
                  </Typography>
                </>
              )}
        ...
        <Box>
                        ...
                        >
                          ...
                          >
                            {continentCountries.map((country, index) => (
                              <Box key={country.id} sx={{ animationDelay: `${index * 50}ms` }}>
                                <DirectoryCard
                                  type="country"
                                  name={country.name}
                                  data={country}
                      ...
                      >
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4, pl: 3 }}>
                          {continentCountries.map((country) => {
                            const countryCities = filteredCities.filter(
                              ...
                              >
                                ...
                                >
                                  {countryCities.map((city, index) => (
                                    <Box key={city.id} sx={{ animationDelay: `${index * 30}ms` }}>
                                      <DirectoryCard
                                        type="city"
                                        name={city.name}
                                        data={city}
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <Box sx={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Typography
                  variant="h6"
                  color="text.secondary"
                  sx={{ maxWidth: '42rem', mx: 'auto' }}
                >
                  Explore the diverse cities and regions of {selectedCountry?.name}. Find your
                  perfect destination with local insights and weather information.
                </Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                >
                  {countryCities.map((city, index) => (
                    <Box key={city.id} sx={{ animationDelay: `${index * 50}ms` }}>
                      <DirectoryCard
                        type="city"
                        name={city.name}
                        data={city}
              ...
              <Box sx={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: 3 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: '42rem', mx: 'auto' }}
                  >
                    Discover everything about {selectedCity?.name}. Get local insights, weather
                    updates, and essential information for your visit.
                  </Typography>
                </Box>
          ...
          {viewMode === 'search' && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  >
                    {searchResults.cities.map((city: any, index: number) => (
                      <Box
                        key={city.id}
                        sx={{
                          animationDelay: `${(searchResults.countries?.length || 0) * 50 + index * 50}ms`,
                        }}
                      >
                        <DirectoryCard
                          type="city"
              ...
              {/* No Results State */}
              {(searchResults.countries?.length || 0) === 0 &&
