...
const PrideBar = ({ height = 1 }) => (
  <div style={{ height, background: "var(--ink)" }} />
);

const TopNav = ({ active = "Discover" }) => (
...
export { PatternHome, PatternSignIn, PatternSignUp, PatternCity, PatternVenueList, PatternVenueDetail, PatternEvents, PatternFestival, PatternHotelSearch, PatternHotelDetail, PatternTravelDeals, PatternMap, PatternVillages, PatternVillageDetail, PatternGroups, PatternGroupDetail, PatternMessaging, PatternNews, PatternArticle, PatternPersonalities, PatternResources, PatternMarketplace, PatternMarketDetail, PatternSearch, PatternTags, PatternWeather, PatternAdmin, PatternCMS, PatternSecurity, PatternHomeMobile, PatternSignInMobile, PatternCityMobile, PatternVenueMobile, PatternEventsMobile, PatternMapMobile };
