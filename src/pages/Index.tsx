              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
                  {Array.from({ length: 4 }).map((_, i) => (
                    /* Mirror MarketplaceCard anatomy (media plate + text block)
                       so hydration doesn't shift the section height. */
                    <div key={i} className="rounded-container border border-border overflow-hidden">
