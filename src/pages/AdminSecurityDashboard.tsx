    ...
    <Card>
      ...
      <CardContent>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
          <Button onClick={anonymizeLocationData} variant="outline" style={{ width: '100%' }}>
            <MapPin style={{ height: 16, width: 16, marginRight: 8 }} />
            Anonymize All Location Data
          </Button>

          <Button onClick={refreshMetrics} variant="outline" style={{ width: '100%' }}>
            <Activity style={{ height: 16, width: 16, marginRight: 8 }} />
            Refresh Security Metrics
          </Button>

          <Button onClick={handleEmergencyLockdown} variant="destructive" style={{ width: '100%' }}>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 3 }}>
          <Alert>
            ...
            <AlertDescription>
              <strong>Enhanced Security Measures Active:</strong> This dashboard includes automatic
              location anonymization, financial data protection, enhanced profile privacy controls,
              and comprehensive security monitoring. All administrative actions are logged and
              audited.
            </AlertDescription>
          </Alert>
        </Box>
        ...
        >
          <TabsList
            style={{ display: 'grid', width: '100%', gridTemplateColumns: '1fr 1fr 1fr 1fr' }}
          >
            <TabsTrigger
              value="monitoring"
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  <Shield style={{ height: 16, width: 16 }} />
                  <AlertDescription>
                    Profile access is now protected by enhanced RLS policies. Sensitive data like
                    sexual orientation, gender identity, and financial information requires explicit
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  <DollarSign style={{ height: 16, width: 16 }} />
                  <AlertDescription>
                    All financial data access requires detailed justification (minimum 20
                    characters) and is subject to enhanced audit logging. Emergency access
                    procedures are available for urgent legal compliance needs.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
