...
import { Plus, Search, Edit, Trash2, ArrowLeft, Tag, Database, RefreshCw } from 'lucide-react';
...
export default function AdminTags() {
  ...
  const handleBulkEdit = async () => {
    const tagsWithoutDescriptions = tags.filter(
          ...
          <Dialog open={isBulkEditOpen} onOpenChange={setIsBulkEditOpen}>
            <DialogContent sx={{ maxWidth: 896, maxHeight: '80vh', overflowY: 'auto' }}>
              <DialogHeader>
                ...
                <Typography variant="body2" color="text.secondary">
                  Add descriptions to tags that don't have them. Suggestions are pre-filled based on
                  tag names.
                </Typography>
              </DialogHeader>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                {Object.keys(bulkEditTags).length === 0 && (
                  <Box sx={{ textAlign: 'center', py: 4 }}>
                    <Typography variant="body2" color="text.secondary">
                      All tags already have descriptions!
                    </Typography>
                  </Box>
                )}
