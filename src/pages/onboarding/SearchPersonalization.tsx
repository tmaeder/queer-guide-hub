...
export default function SearchPersonalization() {
  ...
  const [langs, setLangs] = useState<string[]>([
    browserLang in { en: 1, de: 1, es: 1, fr: 1 } ? browserLang : 'en',
  ]);
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      fetchAutocomplete(cityQuery, ['cities'], 5)
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              {citySuggestions.length > 0 && !cityChoice && (
                <div className="rounded-element bg-muted divide-y">
