          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Please describe your story, interview request, or press inquiry..."
                    required
                  />
                </div>
              ...
              <div className="mt-4 p-3 bg-muted rounded text-sm">
                ...
                <p className="text-muted-foreground">press@thequeerguide.com</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold mb-1">Alex Rivera</h3>
              <p className="text-sm text-primary mb-3">CEO & Co-Founder</p>
              <p className="text-sm text-muted-foreground">
                Former tech executive with 15 years experience building community platforms. 
                Passionate about LGBTQ+ rights and creating inclusive digital spaces.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              <div className="w-20 h-20 bg-gradient-primary rounded-full mx-auto mb-4"></div>
              <h3 className="font-semibold mb-1">Sam Chen</h3>
              <p className="text-sm text-primary mb-3">CTO & Co-Founder</p>
              <p className="text-sm text-muted-foreground">
                Software engineer and security expert focused on building safe, 
                scalable platforms for marginalized communities.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              <div className="w-20 h-20 bg-gradient-primary rounded-full mx-auto mb-4"></div>
              <h3 className="font-semibold mb-1">Jordan Taylor</h3>
              <p className="text-sm text-primary mb-3">Head of Community</p>
              <p className="text-sm text-muted-foreground">
                Community organizer and advocate with deep roots in LGBTQ+ activism 
