...
export function ResourceTagDetail({
  ...
  const primary = selectedTag.categories?.find((c) => c.is_primary) ?? selectedTag.categories?.[0];
        ...
        {selectedTag.image_url ? (
          ...
          >
            ...
            >
              {primary && (
                <p
                  className="font-semibold mb-1 uppercase text-white/65"
              ...
              <h1
                ...
                style={{ textShadow: '0 2px 8px rgba(0,0,0,0.3)', lineHeight: 1.1 }}
              >
                {selectedTag.name}
              </h1>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_240px] gap-8 min-w-0">
          ...
          <div className="flex flex-col gap-6 lg:sticky self-start" style={{ top: 80 }}>
            ...
            <Collapsible open={graphOpen} onOpenChange={setGraphOpen}>
              ...
              <CollapsibleContent>
                <div
                  className="rounded-container overflow-hidden mt-4 bg-surface-container"
                  style={{ height: 420 }}
                >
                  {graphOpen && (
