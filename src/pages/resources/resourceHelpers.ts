...
export const hoverCardCls =
  'flex items-center gap-4 px-4 py-4 rounded-element cursor-pointer bg-background text-left text-inherit w-full transition-all duration-150 hover:bg-muted focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary border-0';
