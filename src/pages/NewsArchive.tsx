...
export default function NewsArchive() {
  ...
  const paginatedArticles = sortedArticles.slice(0, visibleCount);
      ...
      <div className="container mx-auto py-8 md:py-12 px-4 pb-24 relative">
        ...
        {categories.length > 0 && (
          <div
            ...
            className="flex gap-2 mb-6 overflow-x-auto pb-2 sticky top-0 z-20 bg-surface-container-low/95 backdrop-blur supports-[backdrop-filter]:bg-surface-container-low/75 border-b border-border-hairline -mx-4 px-4 pt-2"
