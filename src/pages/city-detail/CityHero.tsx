      ...
      <div className="flex items-start justify-between gap-4 mb-2">
        ...
        <div className="flex gap-2 flex-shrink-0 mt-2 flex-wrap">
          <LocalizedLink
            ...
            className="inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-2.5 text-sm font-bold tracking-tight text-background transition-transform duration-300 hover:-translate-y-0.5 no-underline"
          >
