...
import AdminAccessibilityAttributes from '../AdminAccessibilityAttributes';
...
describe('AdminAccessibilityAttributes', () => {
  it('renders without crashing', () => {
    const { container } = render(<AdminAccessibilityAttributes />, { wrapper });
