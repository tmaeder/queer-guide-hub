...
export default function EmailTemplates() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Archetype H. The page title was an <h4> at text-2xl — the wrong
        heading LEVEL (a page has one h1) and an arbitrary size off the semantic
        scale. Both are what the fixed header grammar exists to stop, and this
        page is the clearest example of why 40 bespoke headers was a problem. */}
      <AdminArchetypeHeader title="Email Templates" />
