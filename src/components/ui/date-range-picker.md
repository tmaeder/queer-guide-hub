...
Source: [`date-range-picker.tsx`](./date-range-picker.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `date-range-picker` primitive. See
...
- **Do** import from `@/components/ui/date-range-picker`.
...
```tsx
import { /* exports */ } from '@/components/ui/date-range-picker';
