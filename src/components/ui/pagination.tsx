...
const Pagination = ({ className, style, ...props }: React.ComponentProps<'nav'>) => (
  <nav
    ...
    className={className}
    style={{ display: 'flex', width: '100%', justifyContent: 'center', margin: '0 auto', ...style }}
    {...props}
  />
);
...
const PaginationLink = ({
  ...
  <a
    ...
    style={{
      ...
      textDecoration: 'none',
      color: 'inherit',
      minWidth: size === 'icon' ? 36 : undefined,
      height: 36,
