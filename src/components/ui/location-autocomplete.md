...
Source: [`location-autocomplete.tsx`](./location-autocomplete.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `location-autocomplete` primitive. See
...
- **Do** import from `@/components/ui/location-autocomplete`.
...
```tsx
import { /* exports */ } from '@/components/ui/location-autocomplete';
