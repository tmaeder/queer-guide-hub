...
Source: [`venue-combobox.tsx`](./venue-combobox.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `venue-combobox` primitive. See
...
- **Do** import from `@/components/ui/venue-combobox`.
...
```tsx
import { /* exports */ } from '@/components/ui/venue-combobox';
