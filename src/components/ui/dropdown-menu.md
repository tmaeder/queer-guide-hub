...
One-line: shadcn-as-MUI wrapper for the `dropdown-menu` primitive. See
...
- **Do** import from `@/components/ui/dropdown-menu`.
...
```tsx
import { /* exports */ } from '@/components/ui/dropdown-menu';
