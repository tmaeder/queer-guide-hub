...
Source: [`carousel.tsx`](./carousel.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `carousel` primitive. See
...
- **Do** import from `@/components/ui/carousel`.
...
```tsx
import { /* exports */ } from '@/components/ui/carousel';
