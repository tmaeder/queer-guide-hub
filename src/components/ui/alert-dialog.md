...
One-line: shadcn-as-MUI wrapper for the `alert-dialog` primitive. See
...
- **Do** import from `@/components/ui/alert-dialog`.
...
```tsx
import { /* exports */ } from '@/components/ui/alert-dialog';
