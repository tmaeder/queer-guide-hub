...
Source: [`avatar.tsx`](./avatar.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `avatar` primitive. See
...
- **Do** import from `@/components/ui/avatar`.
...
```tsx
import { /* exports */ } from '@/components/ui/avatar';
