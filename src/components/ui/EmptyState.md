...
Source: [`EmptyState.tsx`](./EmptyState.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `EmptyState` primitive. See
...
- **Do** import from `@/components/ui/EmptyState`.
...
```tsx
import { /* exports */ } from '@/components/ui/EmptyState';
