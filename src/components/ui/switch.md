...
Source: [`switch.tsx`](./switch.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `switch` primitive. See
...
- **Do** import from `@/components/ui/switch`.
...
```tsx
import { /* exports */ } from '@/components/ui/switch';
