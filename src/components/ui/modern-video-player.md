...
Source: [`modern-video-player.tsx`](./modern-video-player.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `modern-video-player` primitive. See
...
- **Do** import from `@/components/ui/modern-video-player`.
...
```tsx
import { /* exports */ } from '@/components/ui/modern-video-player';
