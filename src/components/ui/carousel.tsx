...
>(
  (
    { orientation = 'horizontal', opts, setApi, plugins, _className, children, style, ...props },
    ref,
  ) => {
        ...
        <div
          ...
          style={{
            ...
            ...(orientation === 'horizontal'
              ? { marginLeft: -16 }
              : { marginTop: -16, flexDirection: 'column' as const }),
            ...style,
          }}
          {...props}
        />
    ...
    return (
      <div
        ...
        style={{
          ...
          flexGrow: 0,
          flexBasis: '100%',
          ...(orientation === 'horizontal' ? { paddingLeft: 16 } : { paddingTop: 16 }),
          ...style,
        }}
        {...props}
      />
...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(
  ({ _className, variant = 'outline', size = 'icon', style, ...props }, ref) => {
