...
Source: [`image-upload.tsx`](./image-upload.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `image-upload` primitive. See
...
- **Do** import from `@/components/ui/image-upload`.
...
```tsx
import { /* exports */ } from '@/components/ui/image-upload';
