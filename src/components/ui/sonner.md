...
Source: [`sonner.tsx`](./sonner.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `sonner` primitive. See
...
- **Do** import from `@/components/ui/sonner`.
...
```tsx
import { /* exports */ } from '@/components/ui/sonner';
