...
Source: [`resizable.tsx`](./resizable.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `resizable` primitive. See
...
- **Do** import from `@/components/ui/resizable`.
...
```tsx
import { /* exports */ } from '@/components/ui/resizable';
