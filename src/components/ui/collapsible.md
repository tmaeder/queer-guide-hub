...
Source: [`collapsible.tsx`](./collapsible.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `collapsible` primitive. See
...
- **Do** import from `@/components/ui/collapsible`.
...
```tsx
import { /* exports */ } from '@/components/ui/collapsible';
