...
Source: [`ContentWarningBanner.tsx`](./ContentWarningBanner.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `ContentWarningBanner` primitive. See
...
- **Do** import from `@/components/ui/ContentWarningBanner`.
...
```tsx
import { /* exports */ } from '@/components/ui/ContentWarningBanner';
