...
Source: [`modern-audio-player.tsx`](./modern-audio-player.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `modern-audio-player` primitive. See
...
- **Do** import from `@/components/ui/modern-audio-player`.
...
```tsx
import { /* exports */ } from '@/components/ui/modern-audio-player';
