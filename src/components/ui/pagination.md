...
Source: [`pagination.tsx`](./pagination.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `pagination` primitive. See
...
- **Do** import from `@/components/ui/pagination`.
...
```tsx
import { /* exports */ } from '@/components/ui/pagination';
