...
Source: [`slider.tsx`](./slider.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `slider` primitive. See
...
- **Do** import from `@/components/ui/slider`.
...
```tsx
import { /* exports */ } from '@/components/ui/slider';
