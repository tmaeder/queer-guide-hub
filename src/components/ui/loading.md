...
Source: [`loading.tsx`](./loading.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `loading` primitive. See
...
- **Do** import from `@/components/ui/loading`.
...
```tsx
import { /* exports */ } from '@/components/ui/loading';
