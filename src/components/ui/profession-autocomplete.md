...
Source: [`profession-autocomplete.tsx`](./profession-autocomplete.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `profession-autocomplete` primitive. See
...
- **Do** import from `@/components/ui/profession-autocomplete`.
...
```tsx
import { /* exports */ } from '@/components/ui/profession-autocomplete';
