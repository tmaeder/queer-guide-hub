...
Source: [`alert.tsx`](./alert.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `alert` primitive. See
...
- **Do** import from `@/components/ui/alert`.
...
```tsx
import { /* exports */ } from '@/components/ui/alert';
