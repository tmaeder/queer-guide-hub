...
Source: [`command.tsx`](./command.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `command` primitive. See
...
- **Do** import from `@/components/ui/command`.
...
```tsx
import { /* exports */ } from '@/components/ui/command';
