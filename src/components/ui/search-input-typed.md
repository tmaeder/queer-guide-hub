...
Source: [`search-input-typed.tsx`](./search-input-typed.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `search-input-typed` primitive. See
...
- **Do** import from `@/components/ui/search-input-typed`.
...
```tsx
import { /* exports */ } from '@/components/ui/search-input-typed';
