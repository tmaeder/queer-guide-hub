...
Source: [`calendar.tsx`](./calendar.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `calendar` primitive. See
...
- **Do** import from `@/components/ui/calendar`.
...
```tsx
import { /* exports */ } from '@/components/ui/calendar';
