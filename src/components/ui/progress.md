...
Source: [`progress.tsx`](./progress.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `progress` primitive. See
...
- **Do** import from `@/components/ui/progress`.
...
```tsx
import { /* exports */ } from '@/components/ui/progress';
