...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-element rounded-b-none border-b-2 border-foreground bg-surface-container px-4.5 py-2 text-sm ring-offset-background transition-all placeholder:text-muted-foreground hover:bg-surface-container-high focus:outline-none focus:ring-2 focus:ring-foreground/15 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
