...
Source: [`LegalPageLayout.tsx`](./LegalPageLayout.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `LegalPageLayout` primitive. See
...
- **Do** import from `@/components/ui/LegalPageLayout`.
...
```tsx
import { /* exports */ } from '@/components/ui/LegalPageLayout';
