...
Source: [`TextType.tsx`](./TextType.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `TextType` primitive. See
...
- **Do** import from `@/components/ui/TextType`.
...
```tsx
import { /* exports */ } from '@/components/ui/TextType';
