...
Source: [`Aurora.tsx`](./Aurora.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `Aurora` primitive. See
...
- **Do** import from `@/components/ui/Aurora`.
...
```tsx
import { /* exports */ } from '@/components/ui/Aurora';
