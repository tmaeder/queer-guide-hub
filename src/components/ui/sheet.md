...
Source: [`sheet.tsx`](./sheet.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `sheet` primitive. See
...
- **Do** import from `@/components/ui/sheet`.
...
```tsx
import { /* exports */ } from '@/components/ui/sheet';
