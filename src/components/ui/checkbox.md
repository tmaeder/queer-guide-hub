...
Source: [`checkbox.tsx`](./checkbox.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `checkbox` primitive. See
...
- **Do** import from `@/components/ui/checkbox`.
...
```tsx
import { /* exports */ } from '@/components/ui/checkbox';
