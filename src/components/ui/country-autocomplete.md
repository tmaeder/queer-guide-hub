...
Source: [`country-autocomplete.tsx`](./country-autocomplete.tsx)

## Purpose

One-line: shadcn-as-MUI wrapper for the `country-autocomplete` primitive. See
...
- **Do** import from `@/components/ui/country-autocomplete`.
...
```tsx
import { /* exports */ } from '@/components/ui/country-autocomplete';
