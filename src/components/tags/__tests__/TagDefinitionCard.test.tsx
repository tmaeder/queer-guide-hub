...
describe('TagDefinitionCard', () => {
  it('renders the definition and a link to the glossary entry', () => {
    ...
    expect(screen.getByText('Longer definition text.')).toBeInTheDocument();
  ...
  it('hides the definition for adult terms when unaffirmed', () => {
    ...
    expect(screen.queryByText(adult.description!)).not.toBeInTheDocument();
  ...
  it('shows the definition for adult terms once affirmed', () => {
    ...
    expect(screen.getByText(adult.description!)).toBeInTheDocument();
  ...
  it('keeps definitions for sensitive non-adult terms', () => {
    ...
    expect(screen.getByText(sensitive.description!)).toBeInTheDocument();
  });
});
