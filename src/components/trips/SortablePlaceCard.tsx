...
export function SortablePlaceCard({
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <div
        className={`group flex items-center gap-2 bg-background px-3 py-2 mb-1 min-h-[44px] transition-colors hover:bg-muted ${isDragging ? 'cursor-grabbing' : 'cursor-default'}`}
      >
        <div
          {...attributes}
          {...listeners}
...
export function PlaceCardOverlay({ place }: { place: TripPlace }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded-md border-2 border-primary bg-background px-3 py-2 w-[320px] opacity-95 shadow-lg">
