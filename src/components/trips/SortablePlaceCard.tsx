...
export function PlaceCardOverlay({ place }: { place: TripPlace }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded-container border border-foreground bg-background px-4 py-2 w-[320px] opacity-95 shadow-[var(--shadow-aceternity-lg)]">
