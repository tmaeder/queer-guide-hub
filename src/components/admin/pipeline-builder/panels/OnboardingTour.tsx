...
const STEPS: Array<{
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="space-y-1.5 text-sm">
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}K</kbd> Quick-add a node</li>
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}F</kbd> Find node on canvas</li>
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}S</kbd> Save</li>
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}Enter</kbd> Run</li>
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}Z</kbd> / <kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">{MOD}L</kbd> Undo / Auto-layout</li>
          <li className="flex items-center gap-2"><kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">?</kbd> Full cheat sheet</li>
        </ul>
      </div>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <p>Pipelines with a <code className="bg-muted px-1 rounded-badge text-xs2">commit</code> node show a confirmation prompt before running for real.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        <p className="mb-4">That's the core loop. Open the <kbd className="h-5 px-1.5 bg-muted rounded-badge border border-border font-mono text-xs2">?</kbd> cheat sheet anytime to see the full list of shortcuts.</p>
