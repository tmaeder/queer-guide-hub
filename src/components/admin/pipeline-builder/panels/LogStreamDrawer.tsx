...
export default function LogStreamDrawer({ pipelineRunId, onClose }: LogStreamDrawerProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 bg-popover border-t border-border max-h-[50vh] flex flex-col animate-in slide-in-from-bottom-4 duration-fast">
