...
export const ChatGPTConnection = () => {
  const { status, loading, testing, connect, disconnect, testConnection, refresh } = useChatGPTConnection();
      ...
      <CardHeader>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <CardDescription>
              Connect ChatGPT via OAuth for AI-powered content enrichment during imports and scraping.
            </CardDescription>
          </div>
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              {isConnected ? (
                ...
                <>
                  ...
                  {hasFallback && (
                    <Badge variant="outline">API key fallback available</Badge>
                  )}
                </>
              )}
            </div>
            ...
            <div style={{ fontSize: '13px', color: '#9ca3af', lineHeight: '1.5' }}>
              When connected, ChatGPT automatically enriches imported venues with LGBTQ+ contextual descriptions,
              classifies events, generates personality bios, and adds relevant tags during imports and scraping.
            </div>
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {isConnected ? (
                <>
                  ...
                  >
                    {testing ? (
                      <RefreshCw style={{ width: 14, height: 14, marginRight: 6, animation: 'spin 1s linear infinite' }} />
                    ) : (
