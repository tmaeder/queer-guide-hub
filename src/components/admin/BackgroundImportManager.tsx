...
export const BackgroundImportManager = ({ onJobUpdate }: BackgroundImportManagerProps) => {
...
// Export the function to create background jobs for use in other components
export { BackgroundImportManager as default };
export const useBackgroundImport = () => {
  const [manager, setManager] = useState<BackgroundImportManager | null>(null);
  
  return {
    createJob: manager?.createBackgroundJob,
    setManager
  };
};