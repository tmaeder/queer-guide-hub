...
import type {
  RecommendedVenueGuide,
  VenueGuideBoostReason,
} from '@/hooks/useRecommendedVenueGuides';
...
const BOOST_LABEL: Record<VenueGuideBoostReason, string> = {
  home_city: 'Near you',
...
function WhyChip({ reason }: { reason: VenueGuideBoostReason }) {
  return (
...
function Eyebrow({ guide }: { guide: RecommendedVenueGuide }) {
