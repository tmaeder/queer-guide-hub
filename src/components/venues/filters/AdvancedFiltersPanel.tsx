...
function PanelBody({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-badge border-2 border-foreground px-3 py-1 text-xs2 font-bold uppercase tracking-label text-foreground mb-4">
