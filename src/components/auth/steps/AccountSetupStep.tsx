...
export default function AccountSetupStep({
  ...
  return <div className="space-y-6">
        ...
        <Tabs defaultValue="build" className="w-full">
          ...
          <TabsContent value="random" className="mt-4">
            <div className="space-y-4 text-center">
              ...
              <Button onClick={generateRandomAvatar} size="lg" className="w-full">
      ...
      <div className="space-y-2">
        ...
        <Textarea id="bio" placeholder="Tell us a bit about yourself... What makes you unique? What are you passionate about?" value={data.bio} onChange={e => updateData({
        bio: e.target.value
      ...
      <div className="space-y-2">
        ...
        <Select value={data.profileVisibility} onValueChange={value => updateData({
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            <Checkbox id="emailNotifications" checked={data.emailNotifications} onCheckedChange={checked => updateData({
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="matchNotifications" checked={data.matchNotifications} onCheckedChange={checked => updateData({
            matchNotifications: checked as boolean
          })} />
