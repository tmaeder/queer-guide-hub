        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-4">
              Airport information not available for {locationName}.
            </p>
            <div className="space-y-2">
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => window.open(`https://www.expedia.com/Flights-Search?flight-type=on&starDate=&endDate=&_xpid=11905%7C1&mode=search&trip=oneway&leg1=from%3A%2Cto%3A${encodeURIComponent(searchQuery || '')}&passengers=adults%3A1%2Cchildren%3A0%2Cseniors%3A0%2Cinfantinlap%3Ay`, '_blank')}
              >
              ...
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => window.open(`https://www.kayak.com/flights/to/${encodeURIComponent(searchQuery || '')}`, '_blank')}
              >
                <ExternalLink className="h-4 w-4 mr-2" />
                Search on Kayak
              </Button>
