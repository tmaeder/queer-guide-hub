...
export const SDGDataPanel: React.FC<SDGDataPanelProps> = ({ data, countryName }) => {
  ...
  return (
    <Card sx={{ borderColor: 'divider' }}>
      <CardHeader>
        <CardTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1 }}>
          ...
          {SDG_GOALS.map((goal) => {
            ...
            return (
              ...
              >
                ...
                {hasValue ? (
                  <>
                    <Typography sx={{ fontSize: '1.25rem', fontWeight: 700, color: 'text.primary', mt: 0.5 }}>
                  ...
                  <Typography sx={{ fontSize: '0.8rem', color: 'text.disabled', mt: 0.5, fontStyle: 'italic' }}>
                    No data available
                  </Typography>
                )}
              </Box>
