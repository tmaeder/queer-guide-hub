...
export const ExploreMap = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute z-10 flex items-center gap-1.5 rounded-full border border-border bg-background/85 backdrop-blur-md px-4 py-1.5 pointer-events-none transition-opacity duration-200"
        style={{
          bottom: 12,
          right: 56,
      ...
      {linkToFullMap && (
        <Button
          ...
          className="absolute bottom-3 left-3 z-10 min-w-0 px-4 py-1.5 rounded-full border border-border normal-case text-xs leading-tight bg-background/85 backdrop-blur-md hover:bg-background"
        >
