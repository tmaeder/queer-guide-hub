  ...
  return (
    <div className="absolute top-3 left-3 z-20 flex flex-col gap-2">
      ...
      <Button
        ...
        className="rounded-container border border-border bg-background/85 backdrop-blur-md shadow-[var(--shadow-aceternity-sm)] hover:bg-background h-10 w-10 p-0"
      >
        <Layers size={18} />
      </Button>
      ...
      <Collapsible open={expanded} onOpenChange={setExpanded}>
        <CollapsibleContent>
          <div className="flex flex-wrap gap-1.5 max-w-[240px] rounded-container border border-border bg-background/85 backdrop-blur-md shadow-[var(--shadow-aceternity-sm)] p-2">
