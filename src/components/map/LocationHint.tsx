...
export function LocationHint({ hint }: { hint: string | null }) {
  if (!hint) return null;
  return (
    <div className="absolute bottom-3 left-3 z-10 flex items-center gap-1.5 rounded-full bg-background/90 backdrop-blur px-4 py-1.5 pointer-events-none animate-fade-in">
