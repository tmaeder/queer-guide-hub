 ...
 *
 * One plate answering "what can I do in the next 60 seconds", with three
 * answers at equal weight: call, write, or steady yourself. Everything a
 * browser needs lives below the seam; nothing in here asks the reader to
 ...
 *
 * At lg+ the plate splits into two columns: ACT on the left (recommended
