...
export const SearchFiltersPanel = ({
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          {contentTypes.map((type) => {
            ...
            return (
              ...
              >
                <IconComponent style={{ height: 12, width: 12 }} className="mr-1" />
                {type.label}
              </Badge>
            );
          })}
      ...
      {/* Location Filter */}
      <div className="flex flex-col gap-2">
        <Label style={{ alignItems: 'center' }} className="text-sm font-medium flex gap-1">
          <MapPin size={12} />
          Location
        </Label>
        <div className="relative">
          ...
          {filters.location && (
            <Button
              variant="ghost"
              size="sm"
              style={{ right: 4, top: 4, height: 24, width: 24 }}
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <Label
              ...
              className="text-sm font-medium inline-flex gap-1.5"
            >
            ...
            {filters.cluster_ids && filters.cluster_ids.length > 0 && (
              <Button
                ...
                style={{ height: 24 }}
                className="text-xs"
                onClick={() => onFiltersChange({ ...filters, cluster_ids: undefined })}
              >
                Clear
              </Button>
            )}
