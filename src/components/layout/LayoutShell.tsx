...
export const LayoutShell = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[9999] focus:bg-card focus:text-foreground focus:px-4 focus:py-2 focus:rounded-element focus:shadow-[var(--shadow-aceternity)] focus:font-semibold focus:text-sm focus:no-underline focus:outline focus:outline-[3px] focus:outline-primary focus:outline-offset-2"
      >
