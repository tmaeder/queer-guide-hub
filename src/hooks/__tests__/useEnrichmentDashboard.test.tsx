...
import { useEnrichmentDashboard } from '../useEnrichmentDashboard';
...
describe('useEnrichmentDashboard', () => { it('should return query shape', () => { const { result } = renderHook(() => useEnrichmentDashboard(), { wrapper: w() }); expect(result.current).toHaveProperty('data'); expect(result.current).toHaveProperty('isLoading'); }); });
