...
// Guards 99991789843669_derby_connecticut_namesake_prose.sql.
//
...
const MIGRATION = '99991789843669_derby_connecticut_namesake_prose.sql';
...
describe('derby connecticut namesake prose: postconditions', () => {
  ...
  it('MIRROR: exactly one row is corrected, so it cannot become a sweep', () => {
    ...
    expect(p5).toContain("'corrected'->>'by' = 'migration:99991789843669'");
