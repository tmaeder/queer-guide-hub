...
/**
 * Guards 82000101100000 — round fifteen, the BODY-SIDE SEAM.
 *
...
const MIGRATION = join(
  process.cwd(),
  'supabase/migrations/82000101100000_tag_prose_body_side_seam.sql',
);
...
describe('82000101100000 — round fifteen, the body-side seam', () => {
