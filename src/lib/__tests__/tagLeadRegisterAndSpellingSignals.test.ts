...
/**
 * Guards 99991789853171 — the glossary lead-register rule and the two counters
 * added beside it.
 *
...
const MIGRATION = '99991789853171_tag_lead_register_and_spelling_signals.sql';
...
describe('99991789853171 — lead register rule + counters', () => {
