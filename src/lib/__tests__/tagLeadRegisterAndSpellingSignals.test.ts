...
/**
 * Guards 99991789854478 — the glossary lead-register rule and the two counters
 * added beside it.
 *
...
const MIGRATION = '99991789854478_tag_lead_register_and_spelling_signals.sql';
...
describe('99991789854478 — lead register rule + counters', () => {
