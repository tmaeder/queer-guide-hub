...
const GATE = 'supabase/migrations/99991789838485_tag_medical_codes_nonclinical_entities.sql';
const WRONG = 'supabase/migrations/99991789838487_tag_justice_infidelity_wrong_entity.sql';
...
describe('the wrong-entity sibling', () => {
  ...
  it('declares an attributed actor — load-bearing for the human_reviewed row', () => {
    ...
    expect(wrongStatements).toMatch(/set_config\('app\.actor', 'migration:99991789838487/);
  });
