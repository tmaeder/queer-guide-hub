...
/**
 * Guards 99920101100100 — the measured rewrite, batch 2 (10 rows of 28 read).
 *
 ...
 *    Voice, so four of eighteen shipped unpublishable (99920101100000). Every
...
const MIG = join(
  process.cwd(),
  'supabase/migrations/99920101100100_tag_description_measured_rewrite_batch2.sql',
);
