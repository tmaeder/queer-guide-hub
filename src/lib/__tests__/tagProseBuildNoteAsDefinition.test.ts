...
/**
 * Guards 99940101100000 — an internal build note published as the definition on
...
const MIGRATION = join(
  process.cwd(),
  'supabase/migrations/99940101100000_tag_prose_build_note_as_definition.sql',
);
...
describe('99940101100000 — build note published as a definition', () => {
