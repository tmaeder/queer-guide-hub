...
const FILE = '79500101143000_tag_name_function_words.sql';
...
describe('79500101143000 — the ladder', () => {
  it('declares an actor (66 affected rows are human_reviewed)', () => {
    expect(apply).toContain(
      "set_config('app.actor', 'migration:79500101143000_tag_name_function_words', true)",
    );
  });
...
describe('79500101143000 — last-run protection', () => {
...
describe('79500101143000 — the repair', () => {
...
describe('79500101143000 — postconditions', () => {
