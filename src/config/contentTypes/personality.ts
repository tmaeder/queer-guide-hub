...
export const personalityFields: FieldConfig[] = [
  ...
  { name: 'profession', label: 'Profession', type: 'profession_autocomplete', group: 'basic', searchable: true },
  {
    ...
    type: 'roles_autocomplete',
    group: 'basic',
    colSpan: 2,
    helpText: 'What the person is known for beyond their occupation — activist, community organizer, etc. Separate from Profession; the same term can be a profession for one person and a role for another. Stored as slugs.',
  },
  ...
  { name: 'achievements', label: 'Achievements', type: 'json', group: 'details' },
  {
    ...
    group: 'details',
    colSpan: 2,
    helpText: 'A single notable first / landmark (e.g. "First openly trans mayor of …"). Shown in the admin milestones stream.',
  },
