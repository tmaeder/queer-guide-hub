...
export const DESTINATIONS: NavDestination[] = [
  ...
  { to: '/feed', icon: Rss, labelKey: 'header.nav.feed', cluster: 'community' },
  { to: '/groups', icon: UsersRound, labelKey: 'header.nav.groups', cluster: 'community' },
  { to: '/users', icon: UserCheck, labelKey: 'header.nav.members', cluster: 'community' },
