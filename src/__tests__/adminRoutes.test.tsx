 ...
 *  3. /admin/pages duplicated /admin/content/cms_pages (which is where nav
 *     points), so the same list had two URLs. It is now a redirect; if someone
 *     resurrects it as a real page the duplication is back.
 *
