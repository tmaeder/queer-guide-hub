...
const FUNCTION_REGISTRY: FunctionMeta[] = [
  ...
  { name: 'redis-get', category: 'api', description: 'Redis cache read', envVars: ['UPSTASH_REDIS_REST_URL', 'UPSTASH_REDIS_REST_TOKEN'] },
  { name: 'redis-set', category: 'api', description: 'Redis cache write', envVars: ['UPSTASH_REDIS_REST_URL', 'UPSTASH_REDIS_REST_TOKEN'] },
  { name: 'redis-delete', category: 'api', description: 'Redis cache delete', envVars: ['UPSTASH_REDIS_REST_URL', 'UPSTASH_REDIS_REST_TOKEN'] },
  { name: 'redis-keys', category: 'api', description: 'Redis key listing', envVars: ['UPSTASH_REDIS_REST_URL', 'UPSTASH_REDIS_REST_TOKEN'] },
  ...
  { name: 'secure-google-maps-key', category: 'api', description: 'Secure Google Maps key proxy', envVars: ['GOOGLE_MAPS_API_KEY'] },
