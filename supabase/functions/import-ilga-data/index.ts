...
import { computeEqualityScore } from '../_shared/equality-score.ts';
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    for (const country of countriesToProcess) {
      ...
      // Calculate equality score (shared canonical formula)
      row.equality_score = computeEqualityScore(row);
