...
import {
  airportQuery, applyLabels, capitalQuery, parseCityFacts, pickAirports, pickCapitals,
  pickUniversities, resolveLabels, sparqlUrl, universityQuery,
  type AirportPick, type CapitalPick, type Claims, type CityWdFacts, type Json,
  type SparqlBinding,
