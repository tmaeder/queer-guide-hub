-- dup_integrity release gate regressed again: 73 venues had chained duplicate_of_id
-- pointers (duplicate pointing to another duplicate). Same recurring fix as
-- 20260607140000 and 20260607420000 — re-point each chained venue directly to
