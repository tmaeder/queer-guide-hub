...
-- 1. Fix RLS on wrappers_fdw_stats table if it exists
DO $$
BEGIN
...
-- 2. Fix infinite recursion in conversation_participants policy
...
-- 3. Strengthen profile security - prevent role escalation through profile updates
...
-- 5. Strengthen marketplace listing security
...
-- 8. Add trigger for sensitive profile changes
...
-- 9. Fix all security definer functions to use proper search_path
