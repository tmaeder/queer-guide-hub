...
--
-- What those merges actually moved is stated precisely in 21000101100000's header and
...
--
-- 21000101100000 makes the nine cores record `details.moved`. This replays it.
--
...
-- 21000101100000 for why each one is what it is. The recorded value is the half of the
