-- Critical Security Fixes: Enhanced Data Protection and Access Controls
...
-- Phase 4: Message Privacy Hardening
-- Simplify message access to strict participant-only
DROP POLICY IF EXISTS "Participants can view messages with complex conditions" ON public.messages;

-- Create simplified secure message policies
CREATE POLICY "Message participants only access"
...
-- Phase 5: Photo Privacy Enhancement
