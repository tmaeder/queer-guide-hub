...
-- 97k row table. After 30 days the outcome is locked into the venues
-- themselves; only 'duplicate' and 'merge_candidate' remain useful as
-- review/forensics handles. Daily cron at 05:00 UTC.
