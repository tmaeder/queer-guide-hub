...
-- directions, so the pass in 20270601200000 does not have to be run a third time.
--
...
-- merge irreversible — including all nine merged by 20270601200000, whose
...
begin
  ...
  -- since 20270601200100 that state is refused outright, so the narrow form
...
begin
  ...
  -- The seal cannot be added while the corpus violates it. 20270601200000 is
