-- Whitelist the four subway-map track-color tokens in branding_validate.
--
-- The 2026-08 subway-map rebrand adds four SEMANTIC track colors
-- (--track-pink/-blue/-green/-yellow: wayfinding lines, fill-only,
-- border-gated) to src/index.css. This migration is the fourth layer of the
-- documented lockstep — index.css -> tokenCatalog.ts -> functions/_lib/
...
--
-- The body below is 20260814100000's verbatim plus the four track keys in
-- v_color_keys. CREATE OR REPLACE needs the whole function, so it is
-- reproduced in full rather than patched.
