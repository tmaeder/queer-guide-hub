-- Security fixes for database functions (without wrappers_fdw_stats)
-- Phase 1: Fix critical security definer functions with search path

-- Update existing security functions to have proper search paths
...
-- Update assign_user_role function to have proper search path
