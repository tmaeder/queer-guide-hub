...
-- Add additional trigger to log passkey access for security monitoring
...
-- Create trigger for passkey access logging
CREATE TRIGGER log_passkey_access_trigger
  AFTER SELECT OR INSERT OR UPDATE OR DELETE ON public.user_passkeys
