...
-- =====================================================
-- PART 1: Fix existing log_enhanced_security_event function
-- =====================================================

-- Update the existing function to work with current table structure
...
BEGIN
  ...
  VALUES (
    p_event_type, 
    p_user_id, 
    p_metadata || jsonb_build_object('severity', p_severity, 'enhanced_logging', true)
  );
END;
$$;
