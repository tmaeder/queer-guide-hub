-- Fix dimension mismatch in get_similar_personalities.
-- content_embeddings.embedding is vector(1024); RPC declared vector(768),
-- so `SELECT ce.embedding INTO source_embedding` 400'd on dimension check.
-- See: supabase/migrations/20260514174522_news_story_clustering.sql (1024)
-- See: supabase/migrations/20260412170000_fix_tag_and_personality_functions.sql (declared 768)
