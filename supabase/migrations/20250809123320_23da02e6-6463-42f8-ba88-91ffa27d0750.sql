-- Minimal, idempotent setup to auto-assign admin to @queer.guide signups
DO $$
BEGIN
...
-- Allow system context in escalation guard
...
-- Helper to check roles (required by guard)
...
-- Auto-assign on signup for queer.guide emails
