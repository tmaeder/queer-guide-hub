...
begin
  ...
  from (values
    -- ANAL / PENETRATIVE ────────────────────────────────────────────────────
    ('afternoon-delight','Afternoon Delight','The bottom sits on the edge of a surface while the top stands to penetrate. A seated-to-standing position that works at desk or table height.'),
    ...
    ('bent-spoons','Bent Spoons','Both partners lie on their sides stacked front-to-back with knees drawn up toward the chest, the top entering from behind. The tucked knees open the angle that flat spooning closes.'),
    ...
    ('bulldog','Bulldog','The bottom on all fours with the top standing behind and above, rather than kneeling. The height difference makes the angle steeper than doggy style.'),
    ('reverse-bulldog','Reverse Bulldog','Both partners on all fours, the top positioned above and behind the bottom.'),
    ('bully-position','Bully (Position)','The bottom kneels while the top stands behind them. Disambiguated from the Dynamics & Roles tag of the same name.'),
    ('bumper-cars','Bumper Cars','The bottom lies down while the top moves over them on all fours, the contact made and broken rather than held.'),
    ('butterfly-position','Butterfly (Position)','The bottom on their back with the top kneeling between their legs, the bottom''s legs opened wide to the sides. Disambiguated from the Slang tag of the same name.'),
    ('cannonball','Cannonball','The bottom sits with the knees pulled in tight toward the chest while the top stands to penetrate.'),
    ('sitting-cannonball','Sitting Cannonball','The tucked cannonball shape with both partners seated rather than one standing.'),
