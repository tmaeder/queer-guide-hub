-- Phase 4 observability, v2. Adds connection coverage (has_connection) and the
-- flagged-non-person count to personality_quality_overview(), and excludes the
-- insufficient_data-triaged bare names from pending_requeue (they are not in the
-- refresh loop). See docs/plans/2026-06-07-personalities-content-quality-design.md.
