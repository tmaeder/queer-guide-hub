...
.github/workflows/         # GitHub Actions (CI, scraper crons, deploy, e2e nightly)
```
...
Covers: venues, events, cities, countries, news, marketplace, personalities, tags, queer_villages.
