...
//     an import is legitimate.
{
  ...
  if (!res.ok) {
    ...
    // reparenting was recorded as counts only. 20330401100000 made
    ...
    if (unreversible > 0) {
      ...
      console.error('  _venue_merge_core is not stamping details.schema — diff it against 20330401100000.')
