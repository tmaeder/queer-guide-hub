  ...
  if (res.status === 404) {
    ...
    if (mc.probe_ok !== true) {
      ...
      if (!('nonclinical_code_rows' in mc)) {
        console.warn('⚠ tag_medical_code_signals has no \'nonclinical_code_rows\' key — the non-clinical gate is NOT DEPLOYED (migration 99991789821608). Absence of a check, not absence of defects.')
      } else {
