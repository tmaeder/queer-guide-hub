...
//
// 20270502164139 inverted the sort keys so staleness outranks reliability, and
...
if (!starveRes.ok) {
  ...
  console.warn('  20270502164139 is not applied, so this check measured NOTHING (it did not pass).')
} else {
